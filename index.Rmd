...
happiness_chart <- 
  happiness %>% 
  filter(Country %in% c("Sweden", "Brazil", "Germany", "Argentina", "Russia")) %>%
...
[OurWorldInData.org/happiness-and-life-satisfaction](https://ourworldindata.org/grapher/Happiness: Happy (aggregate)) \| CC BY
